...
const Files = ({ files }: { files: File[] }) => {
  ...
  return (
    <aside className="w-full m-0 lg:m-4 ml-0 max-w-full lg:max-w-[575px] lg:w-[575px] shrink-0 bg-[#292E3E] overflow-scroll no-scrollbar sticky z-0 shadow-xl shadow-black/20 top-[calc(65px_+_16px)] h-[calc(100vh_-_65px)] lg:h-[calc(100vh_-_65px_-_32px)] rounded-none lg:rounded-lg">
